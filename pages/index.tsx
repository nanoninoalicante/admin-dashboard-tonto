...
export default function Home() {
  ...
  const Hit = (props) => {
    console.log(props)
    return (
      <li className="py-3 sm:py-4 text-gray-900 bg-gray-200 rounded-lg my-1 px-2">
        <div className="flex items-center space-x-4">
          ...
          {data.tag.interests &&
            <div className='py-1 px-2 bg-green-400 rounded-lg text-white'>
              {/* {data.tag.interests.filter((interest) => {
                return props.hit.tagName === 
              })} */}
          </div>
          } 
          <div onClick={() => { setSelectedTag(props.hit.tagName); setModal(true) }}
